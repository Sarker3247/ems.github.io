...
if(isset($_REQUEST['contact_submit']))
{
   ...
   $phone = $_REQUEST['phone'];
	$message = $_REQUEST['message'];
        ...
        {
             $cont_msg='<div class="alert alert-success mt-3 text-center">Message Sent!</div>';
        }

        else
        {
             $cont_msg='<div class="alert alert-warning mt-3 text-center">Fail to Contact</div>';
        } 
}
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="cont">
                    <span>For Any Query, <br> Feel Free to <br> Contact Us!</span>
                </div>
            </div>
            <div class="col-md-6">
